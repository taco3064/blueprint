...
3. Inventory the relevant English and Traditional Chinese guides, CLI help and argument parsing, package exports and TypeDoc output, generated contracts and configuration examples, runtime text, and machine-readable output. Keep separately authored public documentation distinct from registered operational surfaces.
...
5. For public documentation, treat English as the semantic authoring source.
   Verify it against runtime, schema, and generated output first; then evaluate
   whether the Traditional Chinese counterpart rewrites that meaning naturally
   with Taiwan technical terminology. Preserve literal code identifiers,
   commands, filenames, product/library names, and established terms; flag
   unnecessary English mixed into ordinary Chinese prose.
6. Compare English and Traditional Chinese coverage by meaning, not by heading
   count, sentence alignment, or literal translation.
7. Use positive and negative controls whenever a check could pass without exercising the claimed behavior.

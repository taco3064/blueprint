...
| [`revise-an-in-flight-ticket.md`](./references/revise-an-in-flight-ticket.md) | New evidence shows a real gap in a filed issue's plan or acceptance criteria, and `deliver-ticket` has already landed at least one stage against it. |

...
**The label goes into the filed ticket, not only into the discussion.** `deliver-ticket`'s stage comments already carry a measured-versus-reasoned split; the ticket that dispatches them carries none. **A measured claim names the command and the fixture that produced it; a reasoned claim says it was reasoned** — honest and cheap, where the same claim unmarked is what a stage gets built on.

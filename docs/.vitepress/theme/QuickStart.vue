...
const COPY = {
  en: {
    auto: {
      ...
      cmd: 'Run npx @kekkai/blueprint init --topology layer-first --authoring to adopt @kekkai/blueprint in this repo.',
    ...
    guided: {
      ...
      cmd: 'npx @kekkai/blueprint init --topology layer-first --agent claude',
  ...
  'zh-TW': {
    auto: {
      ...
      where: '貼給你的 agent',
      cmd: '請執行 npx @kekkai/blueprint init --topology layer-first --authoring 協助導入 @kekkai/blueprint',

...
/**
 * The playbook's conditional half — `renderVerdict` and the verification step it
 * carries, the only section that does not always render.
 *
 * The passages this shares with `method.ts` come from `playbook.ts`: a text two

...
export const PLUGIN_GATES: GateSpec[] = [
  ...
  { id: 'importBlock', emits: 'import-lite/first + import-lite/no-duplicates', note: 'needs the injected eslint-plugin-import-lite, else emits nothing; catches the two import mistakes an incrementally-editing agent makes — a second import of a module already imported, and an import appended below code. No formatter merges duplicate imports' },

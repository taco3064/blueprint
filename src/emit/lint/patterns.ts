...
export const PLUGIN_GATES: GateSpec[] = [
  ...
  { id: 'importBlock', emits: 'import/first + import/no-duplicates', note: 'needs the injected eslint-plugin-import, else emits nothing; catches the two import mistakes an incrementally-editing agent makes — a second import of a module already imported, and an import appended below code. No formatter merges duplicate imports' },

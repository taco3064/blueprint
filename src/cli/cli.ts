...
const IMPACT_HELP = [
  ...
  'means a stale inline eslint-disable suppresses nothing (common after rule',
  'renames) — the file itself is fine.',
  '',
...
const DOCTOR_HELP = [
  ...
  '    tsconfig paths nor the vite config resolves would send agents into',

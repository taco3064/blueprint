...
const INIT_HELP = [
  ...
  '--authoring. Either topology change runs only after a clean, recoverable Git',
  'preflight and writes measured transformation evidence plus an Agent playbook.',
  ...
  '                          --authoring. Existing config is authoritative. On an',
  '                          existing layer-first app this target starts the guarded',
  '                          Agent transformation. On an existing module-first app,',
  '                          a layer-first target starts the guarded reverse path.',

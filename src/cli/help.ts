...
/**
 * Everything `--help` prints: the usage banner and one text per command.
 *
 * Prose an adopting agent reads, so it lives apart from the dispatch that
 * prints it — a wording pass and a routing change never touch the same file.
 */
export const USAGE = [

...
const INIT_HELP = [
  ...
  '--authoring. Layer-first → module-first runs only after a clean, recoverable Git',
  'preflight and writes measured transformation evidence plus an Agent playbook.',
  'Module-first → layer-first remains unavailable and stops without changing the tree.',
  'Next.js Pages Router is rejected because it requires a framework router migration.',
  '',
  ...
  '                          Agent transformation; it never auto-moves domain code.',

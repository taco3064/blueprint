...
const INIT_HELP = [
  ...
  'the playbook with --authoring, or force the preset with --preset. A workspace',
  'with multiple application roots must select one with survey --source-root first;',
  'its zero-file workspace survey is not a starter verdict.',
  '',
  ...
  '                          The early exit ends by running --preset. Four field agents',

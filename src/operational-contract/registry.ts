...
export const OPERATIONAL_SURFACES = [
  ...
  {
    id: 'module-first-growth-guidance', owner: 'module-first-guidance.ts',
    channel: 'agent-contract', delivery: 'generated',
    audiences: ['coding agents', 'repository maintainers'],
    factProviders: ['resolved Blueprint', 'module-first topology'],
    consumers: ['src/emit/agent/sections.ts', 'src/emit/docs/sections.ts'],
    targets: ['Agent contracts', 'architecture handbook'],
    verification: ['module-first guidance tests', 'greenfield module-first conformance'],
  },
  {
  ...
  },
  {
    ...
    consumers: [
      ...
      'src/bootstrap/transformation-recovery.ts',
  ...
  {
    id: 'transformation-recovery-playbook', owner: 'transformation-recovery.ts',
    channel: 'transformation', delivery: 'generated', audiences: ['transformation agents'],
    factProviders: ['validated retained transformation origin'],
    consumers: ['src/bootstrap/transformation-recovery.ts'],
    targets: ['recovery playbook'], verification: ['recovery conformance tests'],
  },
  {

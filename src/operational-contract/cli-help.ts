...
function renderInitHelp(brownfieldMinFiles: number): OperationalText {
  return operationalText([
    ...
    'and no invented domain module. Layer-first also scaffolds the preset below the',
    `brownfield threshold (${brownfieldMinFiles} source files). Other existing source enters authoring,`,
    'which translates the repository\'s own thresholds and ratchets pre-existing debt with a',
    'baseline: a safe floor, not the recommended ceiling, and tightening it toward the',
    'canonical preset later is the owner\'s call.',

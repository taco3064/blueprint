/**
 * The tolerant JSONC reader for the tsconfig family, and the two reporters that
 * name what it gave up on.
 *
 * Apart from the detection that calls it because it knows nothing about a
 * project: a character scanner whose bounds are its whole correctness argument.
 */

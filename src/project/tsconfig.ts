...
/**
 * The tsconfig project graph, and the two questions the authoring playbook asks
 * of it — what `tsc -b` reads, and what it writes.
 *
 * Apart from the detection that reports a file's presence: everything here reads
 * a config's CONTENT and follows `references` to the next one.
 */
